...
public class Paytmm extends AppCompatActivity implements PaytmPaymentTransactionCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewPrice = findViewById(R.id.textView2);
    ...
    private void generateCheckSum() {
        ...
        final Paytm paytm = new Paytm(
                ...
                txnAmount,
        Constraints.WEBSITE,
                Constraints.CALLBACK_URL,
                Constraints.INDUSTRY_TYPE_ID
    );
    ...
    private void initializePaytmPayment(String checksumHash, Paytm paytm) {
        ...
        paramMap.put("MID", Constraints.M_ID);
